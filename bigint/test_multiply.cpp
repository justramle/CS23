...
int main () {
    ...
    
    {
        ...
        assert(right  ==   56);
        assert(result == 6888);
	std::cout << "===========MILESTONE 3 Multiply==============" << std::endl;
        std::cout << "123 multiply 56: " << result << std::endl;
    }
    ...
    
    {
        ...
        std::cout << "2 multiply 999999: " << result << std::endl;
    }
    {
        //------------------------------------------------------
        // Setup fixture
	...
	std::cout << "2222 multiply 888888888888888888888888888888888888: " << result << std::endl;
    }
	...
	std::cout << "111111111111111111111111111111111111111111 multiply 999999999999999999999999999999999999999999: " << result << std::endl;
    }
